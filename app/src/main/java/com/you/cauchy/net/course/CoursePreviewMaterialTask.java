...
public class CoursePreviewMaterialTask extends AbsCustomTask {

    @Override
    public <Params> void execute(Params params) {
        OkHttpUtils
                .get()
                .url(URL + "/api/courseCodeInstance/getPreviewMaterial")
                .addHeader(CAUCHYSSO, Preferences.getToken())
                .addParams("courseCodeInstanceId", params.toString())
                .build()
